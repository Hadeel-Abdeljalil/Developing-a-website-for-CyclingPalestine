    ...
    <div className=' pb-5 mt-5'>
      <div className='h-50 w-100'>
        <div className='imageStore text-white d-flex align-items-center justify-content-center shadow'>
          <div className=" w-50 ">
           <h1 className="fw-bold font-style  dir me-5 pe-5 ">كل ما تحتاج لرحلتك الأمثل  <span ref={typedElement} className="auto-type"></span> </h1>
                ...
                >
                  <div className="image-container position-relative">
                    ...
                    <div className="icon-container position-absolute bottom-0 start-50 mb-3  d-flex justify-content-center d-icon ">
                      ...
                      <Link onClick={() => addToCart(product._id)} className="icon-card rounded-circle text-dark bg-white d-flex card-icon justify-content-center align-items-center w-100 h-100 col-lg-3 ">
