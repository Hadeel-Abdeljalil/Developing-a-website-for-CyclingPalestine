...
export default function Order() {
    ...
    if (isLoading) {
        return <div className="loading bg-transfer w-100 vh-100 d-flex justify-content-center align-items-center z-3">
            ...
            <form onSubmit={formik.handleSubmit}>
                <div className='d-flex justify-content-center w-100'>
                    <div className='dir  w-50'>
                        <div className='dir   text-end m-3'>
                        ...
                        <div className="row dir w-75">
                            ...
                            <div className="coupon-form">
                                ...
                                <input type="text" placeholder="Coupon Code" className=' ' />
                                <button className='opacity-75'>أرسل</button>
                            </div>
                        </div>
                        </div>
