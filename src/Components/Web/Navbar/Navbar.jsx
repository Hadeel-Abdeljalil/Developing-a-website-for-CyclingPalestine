      ...
      <div className="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <li className="nav-item me-4 ">
          ...
          <li className="nav-item me-4 ">
            ...
            <li className="nav-item me-4">
              <NavLink className=" nav-link border-nav     " activeclassname="active" to="/services">
                خدماتنا
              </NavLink>
            </li>
            <li className="nav-item me-4">
        ...
        {userToken?
        <li className="nav-item me-4">
        <NavLink className="nav-link border-nav" activeclassname="active" to = '/cart'>السلة  <span className="badge badge-info bg-secondary">{count}</span></NavLink>
      </li>
        :null}
        ...
        <ul className="dropdown-menu dir">
          ...
          <li><Link className="dropdown-item" to = "/login">تسجيل الدخول</Link></li>
           ...
           :<>
             ...
             <li><a className="dropdown-item" href="#">الإعدادات</a></li>
